import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.47a8cb65.js";const p={},e=t(`<h2 id="一、querystring" tabindex="-1"><a class="header-anchor" href="#一、querystring" aria-hidden="true">#</a> 一、QueryString</h2><p>请求参数的查询（QueryString）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>GET     /shop/_doc/_search?q=desc:慕课网
