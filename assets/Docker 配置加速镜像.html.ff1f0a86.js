import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as e,b as a}from"./app.e5b261e7.js";const i={},t=a(`<h2 id="一、手动安装-docker" tabindex="-1"><a class="header-anchor" href="#一、手动安装-docker" aria-hidden="true">#</a> 一、手动安装 Docker</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/docker/daemon.json
