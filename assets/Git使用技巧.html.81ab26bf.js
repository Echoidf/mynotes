import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,b as e}from"./app.2dc59b7b.js";const i={},t=e(`<h2 id="使用shell脚本提交git修改" tabindex="-1"><a class="header-anchor" href="#使用shell脚本提交git修改" aria-hidden="true">#</a> 使用shell脚本提交git修改</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
